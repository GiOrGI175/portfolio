    ...
    <div className='relative flex max-w-[500px] min-h-[550px] w-full border p-[20px] border-[#9911ff] rounded-4xl z-20'>
      <form className='flex flex-col gap-[40px] w-full h-full'>
        <label className='flex flex-col '>
          <span className='firaCode m-[10px]  text-[white]'>full name *</span>
          <input
            type='text'
            placeholder='Enter your full name'
            className='firaCode border w-full h-[40px] rounded-4xl p-[20px] border-[#9911ff]  text-[white]'
          />
        </label>
        <label className='flex flex-col'>
          <span className='firaCode m-[10px]  text-[white]'> Email *</span>
          <input
            type='text'
        ...
        <label className='flex flex-col'>
          <span className='firaCode m-[10px]  text-[white]'>Message *</span>
          <textarea
            placeholder='Enter your Message'
            className='firaCode border w-full h-[40px] rounded-4xl p-[20px] min-h-[200px]  border-[#9911ff]  text-[white]'
          />
        </label>
        <button
          type='submit'
